"""
Nettoyage des transactions immobilières DVF en couche Silver.
Filtre les ventes résidentielles parisiennes, corrige les types et extrait l'arrondissement.
Entrée : data/bronze/dvf.csv  →  Sortie : data/silver/transactions_residentiel.csv
"""
...
def clean_dvf(src: str = "data/bronze/dvf.csv",
    ...
    # Détection automatique du séparateur : les exports DVF utilisent parfois ";" parfois ","
    try:
    ...
    # Supprime les lignes parasites contenant la ligne d'en-tête répétée dans les fichiers concaténés
    ...
    # Normalise la virgule décimale française et convertit les colonnes numériques
    ...
    # Conserve uniquement les codes postaux parisiens 75001–75020 et extrait le numéro d'arrondissement
    ...
    # Restreint aux mutations de vente et aux biens résidentiels (appartements et maisons)
