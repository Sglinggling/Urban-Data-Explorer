...
def clean_maternelles(
    src: str | Path = "data/bronze/etablissements-scolaires-maternelles.csv",
    dst: str | Path = "data/silver/ecoles_maternelles_clean.csv",
) -> Path:
    ...
    print(f"[MATERNELLES] OK: {len(out):,} → {dst.resolve()}")
    return dst.resolve()
