...
SRC = "data/bronze/etablissements-scolaires-ecoles-elementaires.csv"
DST = "data/silver/ecoles_elementaires_clean.csv"
...
def to_arr_num(row):
    ...
    al = str(row["Arrondissement"]); m2 = re.search(r"(\d{1,2})", al)
